...
class _CameraPageState extends State<CameraPage> {
  ...
  void _handleTap(TapDownDetails details, BoxConstraints constraints) {
    final offset = Offset(
      ...
      details.localPosition.dy / constraints.minHeight,
    );
  ...
  Widget _circleButton(IconData icon, VoidCallback onTap, {double size = 500}) {
    return ClipOval(
      child: Material(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text('${_zoom.toStringAsExponential(1)}x',
